...
public class MatchService {
    ...
    public MatchFootball enregistrerScore(Long matchId,
        ...
        // Update Classement AUTOMATIQUE (Phase GROUPE ihany)
        if (match.getPhase() == MatchFootball.Phase.GROUPE) {
